...
public:
  ...
  int4 getEntrySize() const { return size; }
  int4 getNumEntries() const { return num; }
...
public:
  ...
  int4 numLoadTables(void) const { return loadpoints.size(); }
  ...
  const LoadTable &getLoadTableByIndex(int4 i) const { return loadpoints[i]; }
