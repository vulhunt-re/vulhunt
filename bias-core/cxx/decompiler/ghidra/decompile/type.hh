...
protected:
  ...
  virtual void cloneInto(Datatype *dt) const=0;	///< Clone the data-type
...
public:
  ...
  uint4 getFlags() const { return flags; }
...
public:
  ...
  virtual void cloneInto(Datatype *dt) const {
    TypeBase *tb = dynamic_cast<TypeBase *>(dt);
    if (tb == (TypeBase *)0)
      throw LowlevelError("TypeBase::cloneInto: incompatible type");
    new(tb) TypeBase(*this);
  }
};
...
public:
  ...
  virtual void cloneInto(Datatype *dt) const {
    TypeChar *tc = dynamic_cast<TypeChar *>(dt);
    if (tc == (TypeChar *)0)
      throw LowlevelError("TypeChar::cloneInto: incompatible type");
    new(tc) TypeChar(*this);
  }
...
public:
  ...
  virtual void cloneInto(Datatype *dt) const {
    TypeUnicode *tu = dynamic_cast<TypeUnicode *>(dt);
    if (tu == (TypeUnicode *)0)
      throw LowlevelError("TypeUnicode::cloneInto: incompatible type");
    new(tu) TypeUnicode(*this);
  }
  virtual void encode(Encoder &encoder) const;
};
...
public:
  ...
  virtual void cloneInto(Datatype *dt) const {
    TypeVoid *tv = dynamic_cast<TypeVoid *>(dt);
    if (tv == (TypeVoid *)0)
      throw LowlevelError("TypeVoid::cloneInto: incompatible type");
    new(tv) TypeVoid(*this);
  }
  virtual void encode(Encoder &encoder) const;
};
...
public:
  ...
  virtual void cloneInto(Datatype *dt) const {
    TypePointer *tp = dynamic_cast<TypePointer *>(dt);
    if (tp == (TypePointer *)0)
      throw LowlevelError("TypePointer::cloneInto: incompatible type");
    new(tp) TypePointer(*this);
  }
  virtual void encode(Encoder &encoder) const;
...
public:
  ...
  virtual void cloneInto(Datatype *dt) const {
    TypeArray *ta = dynamic_cast<TypeArray *>(dt);
    if (ta == (TypeArray *)0)
      throw LowlevelError("TypeArray::cloneInto: incompatible type");
    new(ta) TypeArray(*this);
  }
  virtual void encode(Encoder &encoder) const;
  virtual Datatype *resolveInFlow(PcodeOp *op,int4 slot);
  virtual Datatype* findResolve(const PcodeOp *op,int4 slot);
...
public:
  ...
  virtual void cloneInto(Datatype *dt) const {
    ...
    if (te == (TypeEnum *)0)
      throw LowlevelError("TypeEnum::cloneInto: incompatible type");
    new(te) TypeEnum(*this);
  }
  virtual void encode(Encoder &encoder) const;
};
...
public:
  ...
  const TypeField *getField(int4 i) const { return &field[i]; }	///< Get the i-th field of the struct
  virtual const TypeField *findTruncation(int8 off,int4 sz,const PcodeOp *op,int4 slot,int8 &newoff) const;
  virtual Datatype *getSubType(int8 off,int8 *newoff) const;
  virtual Datatype *nearestArrayedComponentForward(int8 off,int8 *newoff,int8 *elSize) const;
  virtual Datatype *nearestArrayedComponentBackward(int8 off,int8 *newoff,int8 *elSize) const;
  ...
  virtual void cloneInto(Datatype *dt) const {
    ...
    if (ts == (TypeStruct *)0)
      throw LowlevelError("TypeStruct::cloneInto: incompatible type");
    new(ts) TypeStruct(*this);
  }
  virtual void encode(Encoder &encoder) const;
  virtual Datatype *resolveInFlow(PcodeOp *op,int4 slot);
  virtual Datatype* findResolve(const PcodeOp *op,int4 slot);
...
public:
  ...
  virtual void cloneInto(Datatype *dt) const {
    TypeUnion *tu = dynamic_cast<TypeUnion *>(dt);
    if (tu == (TypeUnion *)0)
      throw LowlevelError("TypeUnion::cloneInto: incompatible type");
    new(tu) TypeUnion(*this);
  }
  virtual void encode(Encoder &encoder) const;
  virtual Datatype *resolveInFlow(PcodeOp *op,int4 slot);
  virtual Datatype* findResolve(const PcodeOp *op,int4 slot);
...
public:
  ...
  virtual void cloneInto(Datatype *dt) const {
    TypePartialStruct *tps = dynamic_cast<TypePartialStruct *>(dt);
    if (tps == (TypePartialStruct *)0)
      throw LowlevelError("TypePartialStruct::cloneInto: incompatible type");
    new(tps) TypePartialStruct(*this);
  }
...
public:
  ...
  virtual void cloneInto(Datatype *dt) const {
    TypePartialUnion *tpu = dynamic_cast<TypePartialUnion *>(dt);
    if (tpu == (TypePartialUnion *)0)
      throw LowlevelError("TypePartialUnion::cloneInto: incompatible type");
    new(tpu) TypePartialUnion(*this);
  }
  virtual void encode(Encoder &encoder) const;
  virtual Datatype *getStripped(void) const { return stripped; }
  virtual Datatype *resolveInFlow(PcodeOp *op,int4 slot);
...
public:
  ...
  virtual void cloneInto(Datatype *dt) const {
    TypePointerRel *tpr = dynamic_cast<TypePointerRel *>(dt);
    if (tpr == (TypePointerRel *)0)
      throw LowlevelError("TypePointerRel::cloneInto: incompatible type");
    new(tpr) TypePointerRel(*this);
  }
  virtual void encode(Encoder &encoder) const;
  virtual TypePointer *downChain(int8 &off,TypePointer *&par,int8 &parOff,bool allowArrayWrap,TypeFactory &typegrp);
  virtual bool isPtrsubMatching(int8 off,int8 extra,int8 multiplier) const;
...
public:
  ...
  virtual void cloneInto(Datatype *dt) const {
    TypeCode *tc = dynamic_cast<TypeCode *>(dt);
    if (tc == (TypeCode *)0)
      throw LowlevelError("TypeCode::cloneInto: incompatible type");
    new(tc) TypeCode(*this);
  }
  virtual void encode(Encoder &encoder) const;
};
...
public:
  ...
  virtual void cloneInto(Datatype *dt) const {
    TypeSpacebase *tsb = dynamic_cast<TypeSpacebase *>(dt);
    if (tsb == (TypeSpacebase *)0)
      throw LowlevelError("TypeSpacebase::cloneInto: incompatible type");
    new(tsb) TypeSpacebase(*this);
  }
  virtual void encode(Encoder &encoder) const;
};
...
public:
  ...
  Datatype *getTypedef(Datatype *ct,const string &name,uint8 id,uint4 format,bool rebuild);	///< Create a new \e typedef data-type
