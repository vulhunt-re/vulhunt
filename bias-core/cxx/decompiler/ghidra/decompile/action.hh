...
public:
  ...
  virtual void resetTimeout(const std::optional<std::chrono::milliseconds> timeout);	///< Reset the optional timeout
  virtual void resetTimeout(const std::optional<std::chrono::milliseconds> timeout, const std::chrono::milliseconds start);	///< Reset the optional timeout
