...
extern ElementId ELEM_FUNCTION_CALL;
...
public:
  ...
  virtual int4 beginFunctionCall(const PcodeOp *op)=0;
  virtual void endFunctionCall(int4 id)=0;
...
public:
  ...
  virtual int4 beginFunctionCall(const PcodeOp *op);
  virtual void endFunctionCall(int4 id);
...
public:
  ...
  virtual void endFunction(int4 id) {}
  virtual int4 beginFunctionCall(const PcodeOp *op) { return 0;  }
  virtual void endFunctionCall(int4 id) {}
...
public:
  ...
  int4 beginFunctionCall(const PcodeOp *op) {
    tagtype=call_b; delimtype=begin; ptr_second.fc=op; count=countbase++; return count; }

  void endFunctionCall(int4 id) {
    tagtype=call_e; delimtype=end; count=id; }
